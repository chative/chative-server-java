...
public class ProvisioningConnection implements DispatchChannel {
  ...
  public void onDispatchMessage(String channel, byte[] message) {
    try {
      ...
      if (outgoingMessage.getType() == PubSubMessage.Type.DELIVER) {
        ...
        ListenableFuture<WebSocketResponseMessage> response = client.sendRequest("PUT", "/v1/message", null, Optional.of(body.get()));
  ...
  public void onDispatchSubscribed(String channel) {
    try {
      ...
      this.client.sendRequest("PUT", "/v1/address", null,
