...
public class AccountAuthenticator implements Authenticator<BasicCredentials, Account> {
    ...
    public Optional<Account> authenticate(BasicCredentials basicCredentials)
        ...
        try {
            ...
            return accountsManager.authenticate(authorizationHeader, authenticationFailedMeter, authenticationSucceededMeter);
    ...
    public Optional<Account> authenticate(String authorizationHeader)
            throws AuthenticationException {
        try {
            ...
            return accountsManager.authenticate(header, authenticationFailedMeter, authenticationSucceededMeter);
    ...
    public boolean isDeleted(String uid )  {
        final Optional<Account> account = accountsManager.get(uid);
