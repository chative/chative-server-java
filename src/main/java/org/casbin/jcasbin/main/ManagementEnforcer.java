...
public class ManagementEnforcer extends InternalEnforcer {
    ...
    /**
     * addMemoryPolicy adds an authorization rule to the current policy.
     * If the rule already exists, the function returns false and the rule will not be added.
     * Otherwise the function returns true by adding the new rule.
     *
     * @param params the "p" policy rule, ptype "p" is implicitly used.
     * @return succeeds or not.
     */
    public boolean addMemoryPolicy(List<String> params) {
        return this.addNamedMemoryPolicy("p", params);
    }
    ...
    /**
     * updateMemoryPolicy update an authorization rule to the current policy.
     *
     * @param params1  the old rule.
     * @param params2 the new rule.
     * @return succeeds or not.
     */
    public boolean updateMemoryPolicy(List<String> params1, List<String> params2) {
        return updateMemoryNamedPolicy("p", params1, params2);
    }
     ...
     * @return succeeds or not.
     */
    public boolean addMemoryPolicy(String... params) {
        return this.addMemoryPolicy(Arrays.asList(params));
    }
    ...
    /**
     * AddNamedMemoryPolicy adds an authorization rule to the current named policy.
     * If the rule already exists, the function returns false and the rule will not be added.
     * Otherwise the function returns true by adding the new rule.
     *
     * @param ptype the policy type, can be "p", "p2", "p3", ..
     ...
     * @return succeeds or not.
     */
    public boolean addNamedMemoryPolicy(String ptype, List<String> params) {
        return this.addMemoryPolicy("p", ptype, params);
    }
     ...
     * @return succeeds or not.
     */
    public boolean updateMemoryNamedPolicy(String ptype, List<String> params1, List<String> params2) {
        return updateMemoryPolicy("p", ptype, params1, params2);
    }
    ...
    /**
     * removeMemoryPolicy removes an authorization rule from the current policy.
     * @param params the "p" policy rule, ptype "p" is implicitly used.
     * @return succeeds or not.
     */
    public boolean removeMemoryPolicy(List<String> params) {
        return removeNamedMemoryPolicy("p", params);
    }
    ...
    /**
     * removeNamedMemoryPolicy removes an authorization rule from the current named policy.
     *
     * @param ptype the policy type, can be "p", "p2", "p3", ..
     * @param params the "p" policy rule.
     * @return succeeds or not.
     */
    public boolean removeNamedMemoryPolicy(String ptype, List<String> params) {
        return removeMemoryPolicy("p", ptype, params);
    }
    /**
     * removeNamedPolicy removes an authorization rule from the current named policy.
     *
    ...
    /**
     * addGroupingMemoryPolicy adds a role inheritance rule to the current policy.
     * If the rule already exists, the function returns false and the rule will not be added.
     * Otherwise the function returns true by adding the new rule.
     *
     * @param params the "g" policy rule, ptype "g" is implicitly used.
     * @return succeeds or not.
     */
    public boolean addGroupingMemoryPolicy(List<String> params) {
        return this.addNamedGroupingMemoryPolicy("g", params);
    }
     ...
     * @return succeeds or not.
     */
    public boolean addGroupingMemoryPolicy(String... params) {
        return this.addGroupingMemoryPolicy(Arrays.asList(params));
    }
    ...
    /**
     * addNamedGroupingMemoryPolicy adds a named role inheritance rule to the current policy.
     * If the rule already exists, the function returns false and the rule will not be added.
     * Otherwise the function returns true by adding the new rule.
     *
     * @param ptype the policy type, can be "g", "g2", "g3", ..
     ...
     * @return succeeds or not.
     */
    public boolean addNamedGroupingMemoryPolicy(String ptype, List<String> params) {
        boolean ruleAdded = addMemoryPolicy("g", ptype, params);
        fm.setAviatorEval(null);
        return ruleAdded;
    }
    ...
    /**
     * removeGroupingMemoryPolicy removes a role inheritance rule from the current policy.
     *
     * @param params the "g" policy rule, ptype "g" is implicitly used.
     * @return succeeds or not.
     */
    public boolean removeGroupingMemoryPolicy(List<String> params) {
        return removeNamedGroupingMemoryPolicy("g", params);
    }
     ...
     * @return succeeds or not.
     */
    public boolean removeNamedGroupingMemoryPolicy(String ptype, List<String> params) {
        boolean ruleRemoved = removeMemoryPolicy("g", ptype, params);
